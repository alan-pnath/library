 ...
 * @author ABHIRAMI
 */
public class managelib extends javax.swing.JFrame {

    /**
     * Creates new form managelib
     */
    public managelib() {
        initComponents();
        resetData();
...
private void setPersonTableData() {
       ...
       try{
           ...
           ResultSet rs = prest.executeQuery(sql);
            ...
            Logger.getLogger(managelib.class.getName()).log(Level.SEVERE, null, ex);
        }
}
    /**
    ...
    private void initComponents() {
        ...
        f = new app.bolivia.swing.JCTextField();
        l = new app.bolivia.swing.JCTextField();
        jButton2 = new javax.swing.JButton();
        jButton3 = new javax.swing.JButton();
        n = new app.bolivia.swing.JCTextField();
        p = new app.bolivia.swing.JCTextField();
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, 112, -1));

        jLabel3.setBackground(new java.awt.Color(255, 204, 204));
        jLabel3.setFont(new java.awt.Font("Sitka Text", 3, 18)); // NOI18N
        jLabel3.setText("First name");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, 112, -1));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 410, 140, -1));

        f.setFont(new java.awt.Font("Sylfaen", 3, 14)); // NOI18N
        f.setPlaceholder("Enter first name...");
        jPanel1.add(f, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 210, 30));

        l.setFont(new java.awt.Font("Sylfaen", 3, 14)); // NOI18N
        l.setPlaceholder("Enter last name...");
        jPanel1.add(l, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 210, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 540, 90, 30));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 540, 90, 30));

        n.setFont(new java.awt.Font("Sylfaen", 3, 14)); // NOI18N
        n.setPlaceholder("Enter username...");
        jPanel1.add(n, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 400, 210, 30));

        p.setFont(new java.awt.Font("Sylfaen", 3, 14)); // NOI18N
        p.setPlaceholder("Enter password..");
        jPanel1.add(p, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 460, 210, 30));

        jLabel6.setBackground(new java.awt.Color(0, 0, 0));
        jLabel6.setFont(new java.awt.Font("Sylfaen", 3, 24)); // NOI18N
        jLabel6.setText("LIBRARIAN DETAILS");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 360, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String ps = p.getText();
            PreparedStatement prest;
            String lib = "INSERT INTO login(first_name,last_name,username,password)VALUES('"+fn+"','"+ln+"','"+un+"','"+ps+"')";
            prest = con.prepareStatement(lib);

            int count = prest.executeUpdate();
            if (count>0)
            {
                int i = okcancel("Librarian has been added.");
    ...
    private void rSTableMetro1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rSTableMetro1MouseClicked
        ...
        user_id=Integer.parseInt(rSTableMetro1.getValueAt(rSTableMetro1.getSelectedRow(),0).toString());
        ...
        try{
            ...
            while(rs.next()){
                ...
                f.setText(rs.getString(2));// Retrieves value of the second column in the current row, which is the username field
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managelib.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private app.bolivia.swing.JCTextField f;
    ...
    private app.bolivia.swing.JCTextField l;
    private app.bolivia.swing.JCTextField n;
    private app.bolivia.swing.JCTextField p;
